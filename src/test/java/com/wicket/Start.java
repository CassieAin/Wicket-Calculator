...
public class Start
{
	...
	public static void main(String[] args)
	{
		...
		http_config.setSecurePort(8887);
		...
		if (keystore != null && keystore.exists())
		{
			...
			System.out.println("SSL access to the examples has been enabled on port 8887");
			System.out
				.println("You can access the application using SSL on https://localhost:8887");
			System.out.println();
		}
